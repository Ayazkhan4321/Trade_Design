...
from PySide6.QtWidgets import (
    ...
    QPushButton, QDoubleSpinBox, QTextEdit, QFrame, QCheckBox
)
...
class LimitOrderForm(QWidget):
    ...
    def _create_price_row(self):
        ...
        # 🟢 FIX: Used PlaceholderSpinBox for Entry Price
        ep_ctrl = QHBoxLayout()
        ep_ctrl.setSpacing(0)
        ep_down = QPushButton("▼")
        ep_down.setObjectName("StitchedBtnLeft")
        ep_down.setFixedSize(24, 26)
        
        self.entry_price_input = PlaceholderSpinBox("Entry Price")
        self.entry_price_input.setObjectName("StitchedInput")
        self.entry_price_input.setDecimals(5)
        self.entry_price_input.setMinimum(0.0)
        self.entry_price_input.setMaximum(999999.0)
        ...
        self.entry_price_input.setAlignment(Qt.AlignCenter)
        self.entry_price_input.setFixedHeight(26)
        
        ep_up = QPushButton("▲")
        ep_up.setObjectName("StitchedBtnRight")
        ep_up.setFixedSize(24, 26)
        ...
        ep_ctrl.addWidget(ep_down)
        ep_ctrl.addWidget(self.entry_price_input)
        ep_ctrl.addWidget(ep_up)
    ...
    def update_prices(self, sell_price, buy_price, hub_received_timestamp=None):
        ...
        # Update entry price placeholder if it's still at default 0.0
